import { CACHE_MANAGER, Controller, Get, Inject, Param, Req, Res, UseGuards } from "@nestjs/common";
...
export class PrivateController {
  ...
  async getPrivateFile(@Param('fileName') fileName: any, @Res() res: Response) {
    return res.sendFile(path.join(process.cwd(), `private/static-files/${fileName}`))
  }
}